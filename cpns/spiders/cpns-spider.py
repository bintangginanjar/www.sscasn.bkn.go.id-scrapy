...
class CpnsSpider(scrapy.Spider):
    ...
    def parseLowongan(self, response):
        ...
        for row in response.xpath('//*[@class="table"]//tbody//tr'):            
            ...
            loader.add_xpath('jabatan', 'td[2]//text()')
            loader.add_xpath('lokasi', 'td[3]//text()')
            loader.add_xpath('pendidikan', 'td[4]//text()')
            loader.add_xpath('jenisFormasi', 'td[5]//text()')
            loader.add_xpath('disabilitas', 'td[6]//text()')
            loader.add_xpath('kebutuhan', 'td[7]//text()')
